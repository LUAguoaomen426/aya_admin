  ...
  <div class="app-container">
    ...
    >
      <el-table-column
        ...
        width="50"
      />
      <el-table-column label="provider" prop="provider id" align="center">
      ...
      <el-table-column label="diagnosis" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="estimate cost">
        <template slot-scope="{row}">
          <span>{{ row.estimateCost }}</span>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { fetchList } from '@/api/pre-auth.js'
